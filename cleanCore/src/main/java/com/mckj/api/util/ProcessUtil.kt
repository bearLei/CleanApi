...
object ProcessUtil {
    ...
    fun getAllBackgroundProcess(): List<String> {
        val activityManager =
            CleanCoreMod.app.getSystemService(Context.ACTIVITY_SERVICE) as ActivityManager?
    ...
    fun getRunningApps(): List<PackageInfo>? {
        val packageManager: PackageManager = CleanCoreMod.app.packageManager ?: return null
        ...
        for (pi in installedPackages) {
            ...
            if ((flag and ApplicationInfo.FLAG_SYSTEM == 0)//非系统应用
                ...
                && (pi.packageName != CleanCoreMod.app.packageName) //排除自己
            ) {
                result.add(pi)
            }
        }
    ...
    fun setTopApp(): Boolean {
        ...
        do {
            ...
            val pkgName = CleanCoreMod.app.packageName ?: break
            val activityManager = getActivityManager()
    ...
    fun isMainProcess(): Boolean {
        ...
        if (mainProcessName != null) {
            return CleanCoreMod.app.packageName == mainProcessName
        }
        return !CleanCoreMod.app.packageName.contains(":")
    }
    ...
    fun getActivityManager(): ActivityManager {
        return CleanCoreMod.app.getSystemService(Context.ACTIVITY_SERVICE) as ActivityManager
    }
