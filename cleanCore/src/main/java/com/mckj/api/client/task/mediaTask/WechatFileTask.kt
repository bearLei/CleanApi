...
class WechatFileTask : BaseTask() {
    ...
    private fun getDocumentsOnQ(): List<MediaEntity> {
        ...
        DocumentFile.fromTreeUri(CleanCoreMod.app, uri)?.uri?.let {
            DocumentFile.fromTreeUri(CleanCoreMod.app, it)?.apply {
