...
import com.mckj.api.util.ProcessUtil
...
class RamCacheTask : BaseTask() {
    ...
    private fun getRamCacheEntity(info: PackageInfo): AppJunk {
        val appName: String = AppUtil.getAppName(CleanCoreMod.app, info.packageName).toString() ?: ""
        val icon = AppUtil.getAppIcon(CleanCoreMod.app, info.packageName)
